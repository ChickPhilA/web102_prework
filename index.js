...
const totalNumOfGames = GAMES_JSON.length;
gamesCard.innerHTML = `${totalNumOfGames}`
...
const displayStr = `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${totalNumOfGames} games. Currently, ${unfundedGamesCount} ${unfundedGamesCount === 1 ? "game remains" : "games remain"} unfunded. We need your help to fund these amazing games!`
