...
let countUnfunded = GAMES_JSON.filter( (game) => {
    game.pledged < game.goal ? totalUnfunded += 1 : 0
} )

// create a string that explains the number of unfunded games using the ternary operator
const displayStr = (totalUnfunded === 1) ?
`A total of $${totalAmount.toLocaleString('en-US')} has been raised for 1 game. Currently, ${totalUnfunded} games
remain unfunded. We need your help to fund these amazing games!`
:
`A total of $${totalAmount.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length - totalUnfunded} games. Currently, ${totalUnfunded} games
remain unfunded. We need your help to fund these amazing games!`
...
descriptionContainer.append(unfundedDisplay)
...
const [game1 = {}, game2 = {}] = [...GAMES_JSON].sort((a, b) => 
    b.pledged - a.pledged)

// if u think about it, it's just making a new copy of the GAMES_JSON array using
// a spread, and sorting it based on funding
...
secondPledgedGame.innerHTML = game2.name
